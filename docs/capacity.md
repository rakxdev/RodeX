...
| Per-app write budget | 2 000 **write-units/min** (1 unit per KB: ~100×20 KB rows/min) | Guardrail only: 100 000 units/min |
| Per-app read budget | 40 000/min | Guardrail only: 400 000/min |
| Total per app | 50 000/min | 500 000/min |
| Platform pool | 100 000/min | 2 000 000/min |
